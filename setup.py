...
def update_tool():
	...
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://raw.githubusercontent.com/dmitriy34555/tgparser-main_100-/main/invite.py
			curl -s -O https://raw.githubusercontent.com/dmitriy34555/tgparser-main_100-/main/pars.py
			curl -s -O https://raw.githubusercontent.com/dmitriy34555/tgparser-main_100-/main/setup.py
			curl -s -O https://raw.githubusercontent.com/dmitriy34555/tgparser-main_100-/main/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://github.com/dmitriy34555/tgparser-main_100-')
	print(gr+'$ python3 setup.py -h'+'\n')
